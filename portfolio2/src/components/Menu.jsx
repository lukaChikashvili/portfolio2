 ...
 const goToProjects = () => {
  ...
  return (
    ...
    top-0 left-0 flex flex-col gap-8 items-start justify-center px-36 text-7xl text-white menu '>
       ...
       <h2 className='flex items-center gap-4 opacity-0 cursor-pointer duration-500 ease hover:text-[#31363F] ' onPointerEnter ={() => setMyProject(true)} onPointerLeave ={() => setMyProject(false)} onClick={goToProjects}><span className='text-xl mt-6 '>//003</span>PROJECTS</h2>
